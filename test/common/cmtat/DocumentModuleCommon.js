...
/**
 * In-contract Document Module tests (CMTAT DocumentERC1643Module).
 *
 * Documents are stored on the token itself. Writes are gated by DOCUMENT_ROLE;
 * in the standard (policy-authoritative) deployment the admin holds DOCUMENT_ROLE
 * via the fixture. Reads are public.
 */
function DocumentModuleCommon() {
  context('Document Module', function () {
