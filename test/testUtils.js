...
const EXTRA_INFO_ATTRIBUTES_STANDALONE = [
  '1234567890',
  TERMS,
  'ComplianceTokenCMTATStandalone smart contract',
];
const EXTRA_INFO_ATTRIBUTES_UPGRADEABLE = [
  '1234567890',
  TERMS,
  'ComplianceTokenCMTATUpgradeable smart contract',
];
const EXTRA_INFO_ATTRIBUTES_LITE_STANDALONE = [
  '1234567890',
  TERMS,
  'ComplianceTokenCMTATLiteStandalone smart contract',
];
const EXTRA_INFO_ATTRIBUTES_LITE_UPGRADEABLE = [
  '1234567890',
  TERMS,
  'ComplianceTokenCMTATLiteUpgradeable smart contract',
];
 ...
 */
async function deployComplianceTokenCMTATStandalone(
  forwarderAddress,
  adminAddress,
  policyEngineAddress,
) {
 ...
 */
async function deployComplianceTokenCMTATUpgradeable(
  forwarderAddress,
  adminAddress,
  policyEngineAddress,
) {
  ...
  const cmtat = await upgrades.deployProxy(
    ...
    [adminAddress, ERC20_ATTRIBUTES, EXTRA_INFO_ATTRIBUTES_UPGRADEABLE, policyEngineAddress],
    {
      initializer: 'initialize',
 ...
 */
async function deployComplianceTokenCMTATLiteUpgradeable(
  forwarderAddress,
  adminAddress,
  policyEngineAddress,
) {
  ...
  const cmtat = await upgrades.deployProxy(
    ETHERS_CMTAT_PROXY_FACTORY,
    [adminAddress, ERC20_ATTRIBUTES, EXTRA_INFO_ATTRIBUTES_LITE_UPGRADEABLE, policyEngineAddress],
    {
      initializer: 'initialize',
      constructorArgs: [
        forwarderAddress,
