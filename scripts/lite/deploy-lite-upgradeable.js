...
async function main() {
  ...
  const Factory = await ethers.getContractFactory('ComplianceTokenCMTATLiteUpgradeable', deployer);
  ...
  console.log('ComplianceTokenCMTATLiteUpgradeable (proxy):   ', cmtatProxyAddress);
  console.log('ComplianceTokenCMTATLiteUpgradeable (impl):    ', cmtatImplAddress);
}
