...
import {IPolicyProtected} from "@chainlink/ace/packages/policy-management/src/interfaces/IPolicyProtected.sol";
...
abstract contract PolicyProtectedUpgradeable is Initializable, ERC165Upgradeable, IPolicyProtected {
  ...
  function __PolicyProtected_init(address policyEngine) internal onlyInitializing {
    __ERC165_init();
