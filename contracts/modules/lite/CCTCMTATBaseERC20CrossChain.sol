...
abstract contract CCTCMTATBaseERC20CrossChain is ERC20CrossChainModule, CCIPModule, CCTCMTATBaseERC1404  {
    ...
    */
    ...
    /* ============ View functions ============ */
    function supportsInterface(bytes4 _interfaceId) public view virtual override(ERC20CrossChainModule, CCTCMTATBaseERC1404) returns (bool) {
        return ERC20CrossChainModule.supportsInterface(_interfaceId)|| CCTCMTATBaseERC1404.supportsInterface(_interfaceId);
    }
