...
import {IERC1643, IDocumentEngine} from "../../../../submodules/CMTAT/contracts/interfaces/engine/IDocumentEngine.sol";
import {IDocumentEngineModule} from "../../../../submodules/CMTAT/contracts/interfaces/modules/IDocumentEngineModule.sol";
 ...
 */
abstract contract CCTDocumentEngineModule is Initializable, IDocumentEngineModule, PolicyProtected {
     ...
     *
     */
    function __CCTDocumentEngineModule_init_unchained(IERC1643 documentEngine_)
    ...
    */
    ...
    ) public virtual override(IDocumentEngineModule) runPolicy {
        DocumentEngineModuleStorage storage $ = _getDocumentEngineModuleStorage();
