...
import {IGetCCIPAdmin} from "../../../../submodules/CMTAT/contracts/interfaces/technical/IGetCCIPAdmin.sol";
import {PolicyProtected} from "../../../../submodules/chainlink-ace/packages/policy-management/src/core/PolicyProtected.sol";


/**
 * @title Chainlink CCT specific functions
 * Implements CCT specific functions to make CMTAT compatible with Chainlink CCIP (CCT standard)
 * 
 */
abstract contract CCTModule is IGetCCIPAdmin, PolicyProtected {
    /* ============ Error ============ */
  ...
  * @dev only authorised addresses (onlyCCIPSetAdmin) can call this function, NOT the current ccipAdmin, and 1-step ownership transfer is used.
  * @param newAdmin The address to transfer the CCIPAdmin role to. Setting to address(0) is a valid way to revoke
  * the role
  */ 
  function setCCIPAdmin(address newAdmin) public virtual runPolicy {
