...
/* = Base = */
/* = Core = */
import {ERC20BurnModule, ERC20BurnModuleInternal} from "../../../submodules/CMTAT/contracts/modules/wrapper/core/ERC20BurnModule.sol";
import {ERC20MintModule, ERC20MintModuleInternal} from "../../../submodules/CMTAT/contracts/modules/wrapper/core/ERC20MintModule.sol";
...
import {DocumentEngineModule,  IERC1643} from "../../../submodules/CMTAT/contracts/modules/wrapper/extensions/DocumentEngineModule.sol";
    ...
    CCIPModule
{
    ...
    */
    function __CMTAT_modules_init_unchained(ICMTATConstructor.ERC20Attributes memory ERC20Attributes_, ICMTATConstructor.ExtraInformationAttributes memory extraInformationAttributes_) internal virtual onlyInitializing {
        __CMTAT_commonModules_init_unchained(ERC20Attributes_, extraInformationAttributes_);
    }

    function __CMTAT_commonModules_init_unchained(ICMTATConstructor.ERC20Attributes memory ERC20Attributes_, ICMTATConstructor.ExtraInformationAttributes memory ExtraInformationModuleAttributes_) internal virtual onlyInitializing {
        // Core
